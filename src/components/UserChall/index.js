...
function UserChall({ user }) {
  ...
  return (
    <>
      ...
      {(state.signIn.role === "admin" || state.signIn.point > 300) &&
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader className="title">إضافة التحدي</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <FormControl>
              <FormLabel htmlFor="title label"> عنوان التحدي</FormLabel>
              <Input
                id="title"
                type="text"
